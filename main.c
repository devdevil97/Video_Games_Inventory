...
VideoGame allvideogames[MAX_VIDEO_GAMES]  = {0};
...
int main(){
    ...
    do{
        switch(mainMenu()){
            ...
            case 2:
                {
                    if(videogameCount < MAX_VIDEO_GAMES){
                        ...
                        printf("\nThe video game information added to the inventory successfully.");
                        videogameCount++;
                    }else{
            ...
            case 3:
                {
                    VideoGame videogames[MAX_VIDEO_GAMES] = { 0 };
...
void editVideoGame(){
    ...
    VideoGame editedvideogames[MAX_VIDEO_GAMES] = { 0 };
